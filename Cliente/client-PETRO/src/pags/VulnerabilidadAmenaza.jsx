  ...
  const SeleccionarAmenaza = () => {
    ...
    useEffect(() => {
      async function fetchData() {
        try {
          handleAddRow();
          const activosResponse = await axios.get("https://savarciberpetro-production.up.railway.app/api/activos");
          setActivos(
          ...
          const vulnerabilidadesResponse = await axios.get("https://savarciberpetro-production.up.railway.app/api/vulnerabilidades");
          setVulnerabilidades(
          ...
          const amenazasResponse = await axios.get("https://savarciberpetro-production.up.railway.app/api/amenazas");
          setAmenazas(
    ...
    const saveDataAmenaza = async () => {
      try {
        ...
        for (const data of dataToSend) {
          await axios.post("https://savarciberpetro-production.up.railway.apps/api/amenazasvulnerabilidades", data);
        }
      } catch (error) {
