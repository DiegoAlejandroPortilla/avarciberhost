...
const TablaGA = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get('https://savarciberpetro-production.up.railway.app/api/activos');
  ...
  const handleGuardar = async () => {
    if (modificarIndex !== -1) {
      ...
      await axios.put(`https://savarciberpetro-production.up.railway.app/api/activos/${modificarIndex}`, formulario);
      // Now update the 'datos' state with the updated data
      const response = await axios.get('https://savarciberpetro-production.up.railway.app/api/activos');
      setDatos(response.data);
    } else {
      await axios.post('https://savarciberpetro-production.up.railway.app/api/activos', formulario);
  ...
  const handleEliminar = async (index) => {
    ...
    await axios.delete(`https://savarciberpetro-production.up.railway.app/api/activos/${codigoToDelete}`);
