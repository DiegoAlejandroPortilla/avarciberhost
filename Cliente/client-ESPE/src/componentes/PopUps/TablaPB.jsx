...
const TablaPB = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://savarciberespe-production.up.railway.app/api/probabilidad');
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://savarciberespe-production.up.railway.app/api/amenazas');
  ...
  const handleGuardar = async () => {
    if (modificarIndex !== -1) {
      await axios.put(`https://savarciberespe-production.up.railway.app/api/probabilidad/${modificarIndex}`, formulario);
      const response = await axios.get('https://savarciberespe-production.up.railway.app/api/probabilidad');
      setDatos(response.data);
    } else {
      await axios.post('https://savarciberespe-production.up.railway.app/api/probabilidad', formulario);
      const response = await axios.get('https://savarciberespe-production.up.railway.app/api/probabilidad');
      setDatos(response.data);
    }
  ...
  const handleEliminar = async (index) => {
    ...
    await axios.delete(`https://savarciberespe-production.up.railway.app/api/probabilidad/${idToDelete}`);
