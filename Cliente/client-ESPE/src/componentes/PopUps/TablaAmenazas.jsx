...
const TablaGA = () => {
  ...
  const handleGuardar = async () => {
    if (modificarIndex !== -1) {
      ...
      await axios.put(`https://savarciberespe-production.up.railway.app/api/amenazas/${modificarIndex}`, {
        ...formulario,
      ...
      await axios.post('https://savarciberespe-production.up.railway.app/api/amenazas', {
        ...formulario,
        Tipo: formulario.TipoId, // Use TipoId for the Tipo value
      });
  ...
  const handleEliminar = async (index) => {
    ...
    await axios.delete(`https://savarciberespe-production.up.railway.app/api/amenazas/${codigoToDelete}`);
