...
import { Box, Grid, Paper, Table, TableBody, TableCell, TableRow, TableContainer, TextField, Button, Typography, Modal } from '@mui/material';
...
const TablaSeleccionar = () => {
  ...
  const handleGuardar = () => {
   // setDatos([...datos, formulario]);
    setModalOpen(false);
    axios.post('https://savarciberespe-production.up.railway.app/api/tiposactivos', formulario)
    setFormulario({
      Descripcion: '',
    });
  };
