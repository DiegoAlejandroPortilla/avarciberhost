...
export const Riesgo = () => {
    ...
    const SeleccionarActivo = () => {
        ...
        const handleDateChange = async (date) => {
            ...
            try {
                const response = await axios.get("https://savarciberespe-production.up.railway.app/api/amenazasvulnerabilidades/agrupacion/1");
                    ...
                    for (let i = 0; i < idsArray.length; i += 2) {
                        ...
                        try {
                            const activoVulnerabilidadResponse = await axios.get(
                                `https://savarciberespe-production.up.railway.app/api/amenazasvulnerabilidades/tabla/${currentId}/${currentDate}`
                            );
        ...
        useEffect(() => {
            async function fetchData() {
                try {
                    ...
                    const riesgoResponse = await axios.get('https://savarciberespe-production.up.railway.app/api/amenazasvulnerabilidades/rangos');
