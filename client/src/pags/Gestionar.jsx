    ...
    useEffect(() => {
      async function fetchData() {
        try {
          ...
          const amenazaVulnerabilidadResponse = await axios.get("http://localhost:8800/api/amenazasvulnerabilidades");
      ...
      async function fetchData() {
        try {
          ...
          const riesgoResponse = await axios.get(
            'http://localhost:8800/api/amenazasvulnerabilidades/rangos'
          );
