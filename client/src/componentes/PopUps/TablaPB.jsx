...
const TablaPB = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:8800/api/probabilidad');
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:8800/api/amenazas');
  ...
  const handleGuardar = async () => {
    if (modificarIndex !== -1) {
      await axios.put(`http://localhost:8800/api/probabilidad/${modificarIndex}`, formulario);
      const response = await axios.get('http://localhost:8800/api/probabilidad');
      setDatos(response.data);
    } else {
      await axios.post('http://localhost:8800/api/probabilidad', formulario);
      const response = await axios.get('http://localhost:8800/api/probabilidad');
      setDatos(response.data);
    }
  ...
  const handleEliminar = async (index) => {
    ...
    await axios.delete(`http://localhost:8800/api/probabilidad/${idToDelete}`);
