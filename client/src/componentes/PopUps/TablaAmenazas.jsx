...
const TablaGA = () => {
  ...
  const handleGuardar = async () => {
    if (modificarIndex !== -1) {
      ...
      await axios.put(`http://localhost:8800/api/amenazas/${modificarIndex}`, {
        ...formulario,
      ...
      await axios.post('http://localhost:8800/api/amenazas',{
        ...formulario,
        Tipo: formulario.TipoId, // Use TipoId for the Tipo value
      });
  ...
  const handleEliminar = async (index) => {
    ...
    await axios.delete(`http://localhost:8800/api/amenazas/${codigoToDelete}`);
