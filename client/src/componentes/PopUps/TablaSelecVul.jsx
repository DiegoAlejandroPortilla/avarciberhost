...
const TablaGA = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:8800/api/vulnerabilidades');
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:8800/api/tiposvulnerabilidad');
        // Assuming the response data is an array, you can set it to the 'datos' state
  ...
  const handleGuardar = async () => {
    if (modificarIndex !== -1) {
      ...
      await axios.put(`http://localhost:8800/api/vulnerabilidades/${modificarIndex}`, {
        ...formulario,
      ...
      await axios.post('http://localhost:8800/api/vulnerabilidades',{
        ...formulario,
        Tipo: formulario.TipoId, // Use TipoId for the Tipo value
      });
  ...
  const handleEliminar = async (index) => {
    ...
    await axios.delete(`http://localhost:8800/api/vulnerabilidades/${codigoToDelete}`);
