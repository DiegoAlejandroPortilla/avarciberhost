...
const TablaDV = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:8800/api/dimensionvaloracion');
  ...
  const handleGuardar = async () => {
    if (modificarIndex !== -1) {
      ...
      await axios.put(`http://localhost:8800/api/dimensionvaloracion/${modificarIndex}`, formulario);
      ...
      try {
        ...
        await axios.post('http://localhost:8800/api/dimensionvaloracion', formulario);
  ...
  const handleEliminar = async (index) => {
    ...
    await axios.delete(`http://localhost:8800/api/dimensionvaloracion/${codigoToDelete}`);
